...
// For production: derived from siteConfig.url automatically
const DEFAULT_CALLBACK_URL = `${siteConfig.url}/api/payments/mpesa/callback`;
const CALLBACK_URL = process.env.MPESA_CALLBACK_URL || DEFAULT_CALLBACK_URL;
