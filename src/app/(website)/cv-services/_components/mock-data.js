...
export const services = [
  {
    id: "cv-writing",
    name: "CV Writing",
    description: "Professional CV written by experts who understand the Kenyan job market. ATS-optimized, keyword-rich, and tailored to your target role.",
    icon: "cv",
    tiers: [
      {
        name: "Basic",
      ...
      },
      {
        ...
        price: 1500,
        features: [
          "2-page professional CV",
          "ATS-optimized format",
          "Cover letter included",
          "2 revisions",
          "24-hour delivery",
          "Email delivery (PDF + Word)",
  ...
  },
  {
    ...
    description: "Compelling cover letters that complement your CV and grab the recruiter's attention. Custom-written for each application.",
    icon: "letter",
    tiers: [
      {
        name: "Basic",
  ...
  },
  {
    ...
    description: "Transform your LinkedIn profile into a recruiter magnet. Optimize your headline, summary, and experience sections.",
    icon: "linkedin",
    tiers: [
      {
        name: "Standard",
...
export const pricingComparison = {
  ...
  basic: {
    name: "Basic",
    price: "KSh 500",
    values: ["Yes", "Standard", "No", "1 Page", "1 Revision", "48 Hours", "PDF", "No", "No", "No"],
  },
  professional: {
    name: "Professional",
    price: "KSh 1,500",
    values: ["Yes", "Modern", "Yes", "2 Pages", "2 Revisions", "24 Hours", "PDF + Word", "Yes", "No", "No"],
    popular: true,
  },
  premium: {
    name: "Premium",
    price: "KSh 3,500",
    values: ["Yes", "Custom", "Yes + Thank You", "Custom", "Unlimited", "12 Hours", "All Formats", "Full Makeover", "Yes", "Yes"],
  },
};
