...
/**
 * HomepageSidebar — server component
 *
 * All data is passed as props from the async parent page.jsx.
      ...
      <div className="bg-gradient-to-br from-[#1a56db] to-[#1e3a8a] text-white rounded-xl p-6 mb-7 shadow-sm">
        ...
        <a
          href={`${siteConfig.whatsapp.link}?text=${encodeURIComponent(
            "Hi JobReady, I need document writing help"
          )}`}
          target="_blank"
