...
const PAGE_PATH = "/jobs/entry-level";
...
export async function generateMetadata({ searchParams }) {
  ...
  const q = params.q || "";
  const title = q ? `Entry Level Jobs in Kenya — "${q}"` : PAGE_TITLE;
  const description = q
    ? `Search entry level job results for "${q}" in Kenya. Start your career journey on ${siteConfig.companyName}.`
    : `Browse the latest entry level jobs in Kenya. No experience required — start your career today. Apply now on ${siteConfig.companyName}.`;
...
export default async function EntryLevelJobsPage({ searchParams }) {
  const params = await searchParams;
          ...
          <form action={PAGE_PATH} method="GET" className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                name="q"
                defaultValue={q}
                placeholder="Search entry level jobs by title or keyword..."
          ...
          <div className="lg:col-span-3">
            {jobs.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <h2 className="text-lg font-bold text-gray-900 mb-2">No entry level jobs found</h2>
                <p className="text-gray-500 text-sm mb-6">
                  No entry level positions match your search. New opportunities for fresh graduates are added regularly.
                </p>
                <Link
                  href="/jobs"
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-xl p-5 text-white shadow-md">
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg mb-1">Kickstart Your Career</h3>
