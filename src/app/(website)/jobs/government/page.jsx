...
const PER_PAGE = 20;
const PAGE_TITLE = "Government Jobs in Kenya";
const PAGE_PATH = "/jobs/government";
...
function buildWhere(q) {
  ...
  // Try filtering by categories JSON array first; fall back to title/description text match
  const whereCategories = {
    AND: [
      ...baseFilters,
      {
        categories: {
          path: "$",
          array_contains: "GOVERNMENT_PUBLIC_SECTOR",
        },
      },
    ],
  };
    ...
    AND: [
      ...baseFilters,
      {
        OR: [
          ...
          { title: { contains: "public service" } },
          { title: { contains: "county" } },
          { title: { contains: "ministry" } },
          { title: { contains: "commission" } },
          { description: { contains: "government" } },
...
async function fetchJobs(searchParams) {
  ...
  const { whereCategories, whereFallback } = buildWhere(q);
  ...
  try {
    ...
    // categories JSON filter failed — use fallback
    try {
      const result = await Promise.all([
        db.job.findMany({
          where: whereFallback,
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              {total} {total === 1 ? "vacancy" : "vacancies"} available
            </p>
          </div>
          ...
          <form action={PAGE_PATH} method="GET" className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                name="q"
                defaultValue={q}
                placeholder="Search government jobs by title or keyword..."
          ...
          <div className="lg:col-span-3">
            {jobs.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <h2 className="text-lg font-bold text-gray-900 mb-2">No government jobs found</h2>
                <p className="text-gray-500 text-sm mb-6">
                  No government vacancies match your search. Check back soon — new positions are posted regularly.
                </p>
                <Link
                  href="/jobs"
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-xl p-5 text-white shadow-md">
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg mb-1">Gov Job Alerts</h3>
                <p className="text-teal-100 text-sm mb-4 leading-relaxed">
                  Never miss a government vacancy. Get a professional CV and be ready when the next one opens.
                </p>
                <a
