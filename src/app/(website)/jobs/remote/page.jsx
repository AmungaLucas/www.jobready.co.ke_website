...
const PER_PAGE = 20;
const PAGE_TITLE = "Remote Jobs in Kenya";
const PAGE_PATH = "/jobs/remote";
          ...
          <form action={PAGE_PATH} method="GET" className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                name="q"
                defaultValue={q}
                placeholder="Search remote jobs by title or keyword..."
          ...
          <div className="lg:col-span-3">
            {jobs.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <h2 className="text-lg font-bold text-gray-900 mb-2">No remote jobs found</h2>
                <p className="text-gray-500 text-sm mb-6">
                  No remote positions match your search. Check back soon — new work-from-home jobs are posted daily.
                </p>
                <Link
                  href="/jobs"
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-xl p-5 text-white shadow-md">
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg mb-1">Work From Anywhere</h3>
                <p className="text-teal-100 text-sm mb-4 leading-relaxed">
                  Stand out in the remote job market with a professional CV tailored for remote roles.
                </p>
                <a
